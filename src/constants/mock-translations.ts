...
export const MOCK_TRANSLATION: Resource = {
  en: {
    translation: {
      ABOUT_US: 'About Us',
      GAMES: 'Games',
      ...
      OUR_GAMES: 'Our Games',
      OUR_GAMES_SECTION_DESCRIPTION:
        'As a pioneer of mobile app gamification, we take pride in originality and individuality, providing global players with magnificent animation that never ceases to impress.',
